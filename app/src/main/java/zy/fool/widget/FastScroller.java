...
class FastScroller {
    ...
    public FastScroller(Context context, FoolAbsView listView) {
        mList = listView;
        init(context);
    }
    ...
    void onScroll(FoolAbsView view, int firstVisibleItem, int visibleItemCount, 
            int totalItemCount) {
...
//            } else 
    ...
    void beginDrag() {
        ...
        if (mList != null) {
            ...
            mList.reportScrollStateChange(FoolAbsView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
        }
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (mState == STATE_DRAGGING) {
                if (mList != null) {
                    ...
                    mList.reportScrollStateChange(FoolAbsView.OnScrollListener.SCROLL_STATE_IDLE);
                }
                setState(STATE_VISIBLE);
