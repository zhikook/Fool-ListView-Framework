 ...
 *
 * <p>
 * See {@link FoolView}, {GridView}, {Spinner} and
...
public abstract class FoolAdapterView<T extends Adapter> extends ViewGroup {
    ...
    public FoolAdapterView(Context context) {
        super(context);
    }

    public FoolAdapterView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
	public FoolAdapterView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(FoolAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(FoolAdapterView<?> parent, View view, int position, long id);
    }
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(FoolAdapterView<?> parent, View view, int position, long id);
         ...
         */
        void onNothingSelected(FoolAdapterView<?> parent);
    }
     ...
     */
    @zy.android.view.RemotableViewMethod
    ...
    class AdapterDataSetObserver extends DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (FoolAdapterView.this.getAdapter().hasStableIds() && mInstanceState != null
                    && mOldItemCount == 0 && mItemCount > 0) {
                FoolAdapterView.this.onRestoreInstanceState(mInstanceState);
                mInstanceState = null;
            } else {
                rememberSyncState();
            }
        ...
        public void onInvalidated() {
            ...
            if (FoolAdapterView.this.getAdapter().hasStableIds()) {
                // Remember the current state for the case where our hosting activity is being
                // stopped and later restarted
                mInstanceState = FoolAdapterView.this.onSaveInstanceState();
            }
