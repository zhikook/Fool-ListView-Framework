 ...
 * and draw the effect using {@link #draw(android.graphics.Canvas)} in the widget's overridden
 * {@link android.view.View#draw(android.graphics.Canvas)} method. If {@link #isFinished()} returns
 ...
 * {@link #draw(android.graphics.Canvas)} method.</p>
 */
public class EdgeEffect {
     ...
     * after a call to {@link #draw(android.graphics.Canvas)} the host widget should schedule another
     ...
     *
     * <p>When using a {@link zy.android.widget.Scroller} or {@link zy.android.widget.OverScroller},
